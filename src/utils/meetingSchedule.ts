...
export const createMeetingSchedule = async (reqBody: any) => {
  try {
    await refreshToken();
    await axios.post(
      `${process.env.REACT_APP_API_BASE_URL_CLIENT as string}/meeting-schedule`,
      reqBody
    );
    return {
      statusCode: 201,
...
export const sendMeetingSchedule = async (
  reqBody: any,
  projectId: string,
  mtId: string
) => {
  try {
    ...
    }/project/${projectId}/meeting-schedule/${mtId}`;
...
export const setDateMeetingSchedule = async (reqBody: any) => {
  try {
    ...
    }/meeting-schedule/${reqBody.meetingScheduleId as string}/date`;
...
export const listMeetingScheduleInClass = async (
  reqQuery: any,
  classId: string
) => {
  try {
    ...
    const url = `${
      process.env.REACT_APP_API_BASE_URL_CLIENT as string
    }/class/${classId}/meeting-schedule`;
...
export const listSendMeetingScheduleInClass = async (
  reqQuery: any,
  classId: string,
  projectId: string
) => {
...
export const getSendMeetingScheduleInClass = async (
  classId: string,
  projectId: string,
  mtId: string
) => {
  try {
    ...
    const url = `${
      process.env.REACT_APP_API_BASE_URL_CLIENT as string
    }/class/${classId}/project/${projectId}/meeting-schedule/${mtId}/detail`;
...
export const cancelSendMeetingSchedule = async (
  projectId: string,
  mtId: string
) => {
  try {
...
export const disabeMeetingScheduleInClass = async (
  ...
  try {
    ...
    const url = `${
      process.env.REACT_APP_API_BASE_URL_CLIENT as string
    }/class/${classId}/meeting-schedule/${mtId}/date/status`;
...
export const updateMeetingSchedule = async (
  ...
  try {
    ...
    const url = `${
      process.env.REACT_APP_API_BASE_URL_CLIENT as string
    }/meeting-schedule/${mtId as string}`;
...
export const changeStatusMeetingSchedule = async (
  status: boolean,
  projectId: string,
  mtId: string
) => {
