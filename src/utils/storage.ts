import { listAll, ref, uploadBytesResumable, getMetadata, StorageReference, deleteObject } from "firebase/storage"
...
export const deleteDocumentFromStudent = async (projectId: string, documentId: string) => {
    try {   
