...
import { listProjectSendDocumentInClass } from "../../utils/document";
              ...
              {projects.map((data) => (
                ...
                >
                  ...
                  <TableCell
                    ...
                    sx={{
                      fontSize: 20,
                      color: data.document.length
                        ? statusList[data.document[0].sendStatus].color
                        : statusList[0].color,
                      fontWeight: 600,
                    }}
                  >
                    {data.document.length
                      ? statusList[data.document[0].sendStatus].message
                      : "ยังไม่ส่ง"}
                  </TableCell>
                </TableRow>
              ))}
